...
`R` uses basic syntax for simple arithmetics. In the following, the gray blocks are `R` codes you can type into the `console` window to try them out. The white blaocks are outputs. 
