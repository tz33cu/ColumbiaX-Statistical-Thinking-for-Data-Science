...
-  CRAN has a number of manuals online.
...
-  A data set is usually in the form of a matrix or array or data frame.
...
`R` uses basic syntax for simple arithmatics. In the following, the gray blocks are `R` codes you can tyep into the `console` window to try them out. The white blaocks are outputs. 
